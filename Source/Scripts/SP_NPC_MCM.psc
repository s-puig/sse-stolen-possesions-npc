...
Event OnPageReset(string pageName)
    ...
    ElseIf (pageName == PAGE_HUMANOID)
        ...
        AddToggleOptionST("CITIZEN_ENABLE", "Enable", SP_NPC_Citizen)
        ;Bandits
        AddHeaderOption("Outlaws")
        AddToggleOptionST("OUTLAW_ENABLE", "Enable", SP_NPC_Outlaw)
        ;Supernatural
        AddHeaderOption("Outcasts")
        AddToggleOptionST("OUTCAST_ENABLE", "Enable", SP_NPC_Outcast)
        ;Dragon related
        AddHeaderOption("Dragon cult")
        AddToggleOptionST("DRAGONCULT_ENABLE", "Enable", SP_NPC_DragonCult)
    ElseIf (pageName == PAGE_CREATURE)
        ;Daedras
        AddHeaderOption("Daedra")
        AddToggleOptionST("DAEDRA_ENABLE", "Enable", SP_NPC_Daedra)
        AddHeaderOption("Domestic animals")
        AddToggleOptionST("DOMESTIC_ENABLE", "Enable", SP_NPC_Domestic)
        AddHeaderOption("Game animals")
        AddToggleOptionST("HUNT_ENABLE", "Enable", SP_NPC_Hunt)
        AddHeaderOption("Wild predators")
        AddToggleOptionST("PREDATOR_ENABLE", "Enable", SP_NPC_Predator)
        AddHeaderOption("Wild creatures")
        AddToggleOptionST("WILD_ENABLE", "Enable", SP_NPC_Wild)
        AddHeaderOption("Dwarven automatons")
        AddToggleOptionST("DWARVEN_ENABLE", "Enable", SP_NPC_Dwarven)
    ElseIf (pageName == PAGE_FACTION)
        AddHeaderOption("The Companions")
        AddToggleOptionST("COMPANION_ENABLE", "Enable", SP_NPC_Companion)
        AddHeaderOption("The College of Winterhold")
        AddToggleOptionST("COLLEGE_ENABLE", "Enable", SP_NPC_College)
        AddHeaderOption("Thieves Guild")
        AddToggleOptionST("THIEVES_ENABLE", "Enable", SP_NPC_ThievesG)
        AddHeaderOption("The Darkbrotherhood")
        AddToggleOptionST("DBROTHERHOOD_ENABLE", "Enable", SP_NPC_DBrotherhood)
        AddHeaderOption("Civil War")
        AddToggleOptionST("CW_ENABLE", "Enable", SP_NPC_CW)
        AddHeaderOption("Thalmor")
        AddToggleOptionST("THALMOR_ENABLE", "Enable", SP_NPC_Thalmor)
        AddHeaderOption("Silver Hand")
        AddToggleOptionST("SILVERHAND_ENABLE", "Enable", SP_NPC_SilverHand)
        AddHeaderOption("Alik'r")
        AddToggleOptionST("ALIKR_ENABLE", "Enable", SP_NPC_Alikr)
        AddHeaderOption("Volkihar")
        AddToggleOptionST("VOLKIHAR_ENABLE", "Enable", SP_NPC_Volkihar)
        AddHeaderOption("Dawnguard")
        AddToggleOptionST("DAWNGUARD_ENABLE", "Enable", SP_NPC_Dawnguard)
    EndIf
